...
lhs = [polynomial_ring('(x1 - 4) * (63504 / 10000 - x1)'), polynomial_ring('(x2 - 4) * (63504 / 10000 - x2)'), polynomial_ring('(x3 - 4) * (63504 / 10000 - x3)'), polynomial_ring('(x4 - 4) * (63504 / 10000 - x4)'), polynomial_ring('(x5 - 4) * (63504 / 10000 - x5)'), polynomial_ring('(x6 - 4) * (63504 / 10000 - x6)')]
