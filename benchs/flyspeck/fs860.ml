...
(* bound on x4 : x4 \in [2.51952632905, 6.3504] *)
let b4 = Sos.((x4 - 251952632905 / 100000000000) * (63504 / 10000 - x4))
(* bound on x5 : x5 \in [2.51952632905, 9.0601] *)
let b5 = Sos.((x5 - 251952632905 / 100000000000) * (90601 / 10000 - x5))
(* bound on x6 : x6 \in [5.6644, 16] *)
let b6 = Sos.((x6 - 56644 / 10000) * (16 / 1 - x6))
...
let _ =
  let polys = Parse.file "fs860.v" in
