...
lhs = [polynomial_ring('-(14/100     + (x1 * x4 * ((- x1) + x2 + x3 - x4 + x5 + x6)        + x2 * x5 * (x1 - x2 + x3 + x4 - x5 + x6)          + x3 * x6 * (x1 + x2 - x3 + x4 + x5 - x6) - x2 * x3 * x4            - x1 * x3 * x5 - x1 * x2 * x6 - x4 * x5 * x6))'), polynomial_ring('-(-25/1     + ((- x2) * x3 - x1 * x4        + x2 * x5          + x3 * x6 - x5 * x6 + x1 * ((- x1) + x2 + x3 - x4 + x5 + x6)))'), polynomial_ring('(x1 - 606887582536 / 100000000000) * (702674064 / 100000000 - x1)'), polynomial_ring('(x2 - 4) * (8 - x2)'), polynomial_ring('(x3 - 2) * (2 - x3)'), polynomial_ring('(x4 - 2) * (2 - x4)'), polynomial_ring('(x5 - 2) * (2 - x5)'), polynomial_ring('(x6 - 4) * (8 - x6)')]
