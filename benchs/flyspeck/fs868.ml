...
(* bound on x5 : x5 \in [9.0601, 25.4016] *)
let b5 = Sos.((x5 - 90601 / 10000) * (254016 / 10000 - x5))
(* bound on x6 : x6 \in [4, 9.0601] *)
let b6 = Sos.((x6 - 4 / 1) * (90601 / 10000 - x6))
...
let _ =
  let polys = Parse.file "fs868.v" in
