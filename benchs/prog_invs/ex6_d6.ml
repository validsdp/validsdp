...
let check_inv p =
  ...
  let sigma1 = Sos.make ~n:4 ~d:4 "s1" in
  let sigma2 = Sos.make ~n:4 ~d:4 "s2" in
  let sigma3 = Sos.make ~n:4 ~d:4 "s3" in
  let sigma4 = Sos.make ~n:4 ~d:4 "s4" in
  ...
  let coeff = Sos.make "c" in
  let sigma = Sos.make ~n:4 ~d:6 "s" in
  let sigma0 = Sos.make ~n:4 ~d:10 "s0" in
  ...
  let coeff = Sos.make "c" in
  let sigma = Sos.make ~n:4 ~d:6 "s" in
  let sigma1 = Sos.make ~n:4 ~d:10 "s1" in
