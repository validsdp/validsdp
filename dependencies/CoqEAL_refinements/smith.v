...
Require Import mathcomp.algebra.ssralg mathcomp.algebra.ssrint mathcomp.algebra.ssrnum mathcomp.ssreflect.fintype.
Require Import CoqEAL_theory.dvdring mathcomp.algebra.matrix mathcomp.algebra.mxalgebra mathcomp.ssreflect.bigop mathcomp.algebra.zmodp mathcomp.fingroup.perm CoqEAL_theory.mxstructure.
Require Import refinements seqmatrix CoqEAL_theory.edr.
...
Admitted.
(* TODO
rewrite -/(let: (_,j,_) := (i,j,k) in (size j <= minn m' n')%N) -H Ih.
Qed.
*)
