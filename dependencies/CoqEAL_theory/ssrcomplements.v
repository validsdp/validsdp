...
Require Import mathcomp.ssreflect.ssreflect mathcomp.ssreflect.ssrfun mathcomp.ssreflect.ssrbool mathcomp.ssreflect.eqtype mathcomp.ssreflect.ssrnat mathcomp.ssreflect.div mathcomp.ssreflect.seq mathcomp.ssreflect.path.
Require Import mathcomp.algebra.ssralg mathcomp.ssreflect.fintype mathcomp.ssreflect.finfun mathcomp.fingroup.perm mathcomp.algebra.matrix mathcomp.ssreflect.bigop mathcomp.algebra.zmodp mathcomp.algebra.mxalgebra.
Require Import mathcomp.ssreflect.choice mathcomp.algebra.poly mathcomp.algebra.polydiv mathcomp.algebra.mxpoly mathcomp.ssreflect.binomial.
...
Proof. elim: s m => // a l ih [|n h] //; apply /ih /path_sorted /h. Qed.
