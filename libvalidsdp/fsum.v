(** * Bounds on the rounding error of summation $\sum_{i=0}^n a_i$#\sum_{i=0}^n x_i# *)
...
(* TODO: meilleure définition en utilisant mieux mathcomp ? *)
Record nat_finset := {
...
Fixpoint fsum n (order : binary_tree) (a : F^n.+1) : F :=
  match order with
  | Leaf i => a (inord i)
  | Node l r => fplus (fsum l a) (fsum r a)
  end.
