...
Section Primitive_float_infnan.
  ...
  Proof.
    ...
    all: first
      [ by rewrite /FI2FS /fiplus /= add_equiv; f_equal; apply BSN_Bplus_congr
      | by move: H;
  ...
  Proof.
    ...
    (* the order of the goals generated by [rewrite] is version dependent *)
    all: first
      [ by rewrite /FI2FS /fiminus /= sub_equiv; f_equal; apply BSN_Bminus_congr
      | by move: H;
  ...
  Proof.
    ...
    (* the order of the goals generated by [rewrite] is version dependent *)
    all: first
      [ by rewrite /FI2FS /fimult /= mul_equiv; f_equal; apply BSN_Bmult_congr
      | by move: H;
           rewrite -(B2Prim_Prim2B (x * y)) finite_equiv mul_equiv;
           apply eqbLR; f_equal; apply BSN_Bmult_congr ].
  Qed.
  ...
  Proof.
    ...
    (* the order of the goals generated by [rewrite] is version dependent *)
    all: first
      [ by rewrite /FI2FS /fidiv /= div_equiv; f_equal; apply BSN_Bdiv_congr
      | by move: H;
  ...
  Proof.
    ...
    (* the order of the goals generated by [rewrite] is version dependent *)
    all: first
      [ by rewrite /FI2FS /fidiv /= sqrt_equiv; f_equal; apply BSN_Bsqrt_congr
      | by move: H;
