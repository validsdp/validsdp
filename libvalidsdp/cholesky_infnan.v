...
{ move=> j i Hij.
  ...
  (* the order of the goals generated by [rewrite] is version dependent *)
  all: first
    ...
    | move: (Hjj j); rewrite H' => H2;
      ...
      rewrite -H // ffunE => H3;
      have H4 : i = inord (Ordinal Hij);
        [by rewrite inord_val|by rewrite H4] ]. }
move=> j.
rewrite mxE H' ytildes_infnan_eq_ytildes; try (by rewrite -H'; apply FIS2FS_spec).
