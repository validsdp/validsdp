...
Definition F2FI (f : F.type) : coqinterval_infnan.FI := Build_FI _ (F2FI_proof f).

Lemma F2FI_correct (f : F.type) : coqinterval_infnan.finite (F2FI f) ->
                                  coqinterval_infnan.FI2F (F2FI f) = toR f :> R.
Proof.
case f => // m e.
rewrite /coqinterval_infnan.finite FtoX_real /coqinterval_infnan.FI2F.
