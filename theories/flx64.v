...
Proof. now apply generic_format_FLX_1. Qed.
...
Proof.
now apply plus_error_le_l; [apply FLX_exp_valid|apply FS_prop|apply FS_prop].
Qed.
...
destruct (@sqrt_error_N_FLX_ex radix2 _ Pprec choice Hprec1 _ (FS_prop x))
  as (d, (Hd, Hr)).
replace (u_ro _ _) with eps in Hd;
