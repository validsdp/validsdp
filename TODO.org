...
**** TODO Migrate iteri_ord, cholesky_prog			     :Pierre:
**** TODO Migrate multipoly					       :Erik:
**** STARTED refine effmpoly from rat to bigQ			       :Erik:
*** TODO Define fcts with "check_size" to discharge the last 2 goals   :Erik:
*** TODO Fix Ltac parsing w.r.t integers/rationals		       :Erik:
*** TODO Finish writing the tactic				       :Erik:
*** TODO Prove ZZtoQ_correct					       :Erik:
*** TODO Prove interp_poly_correct
*** TODO param_soscheck, param_max_coeff, param_check_base
