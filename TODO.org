...
*** TODO Prove param_dotmulB0					       :Erik:
*** DONE Prove param_{seq,}_store3                                   :Pierre:
*** TODO Prove param_posdef_check
...
*** TODO Symmetry test (to define using standard notations %HC) :Pierre:Erik:
...
** TODO Refinement to remove proofs from coqinterval_infnan
